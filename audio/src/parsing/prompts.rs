...
lazy_static! {
    static ref MAJOR: [Message; 5] = [
        ...
        Message {
            ...
            -And I decided to make moves. And I cheated all through school. And it's kind of humblingto talk about my story sometimes and it's also embarrassing but it's real. It's who the fuckI am.".to_string()
            },
        Message {
